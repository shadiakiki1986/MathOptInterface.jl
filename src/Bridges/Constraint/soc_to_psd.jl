...
MOIB.added_constraint_types(::Type{SOCtoPSDBridge{T}}) where T = [(MOI.VectorAffineFunction{T}, MOI.PositiveSemidefiniteConeTriangle)]
...
MOIB.added_constraint_types(::Type{<:RSOCtoPSDBridge{T}}) where T = [(MOI.VectorAffineFunction{T}, MOI.PositiveSemidefiniteConeTriangle)]
